...
export const OTHER_CHAIN_SUPPORTED_CURRENCIES = [
    "sui",
    "sei",
    "ada",
    "apt",
...
export const SUPPORTED_CURRENCIES = [...EVM_SUPPORTED_CURRENCIES, ...SOLANA_SUPPORTED_CURRENCIES, ...OTHER_CHAIN_SUPPORTED_CURRENCIES] as const;
