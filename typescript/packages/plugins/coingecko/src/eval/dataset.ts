...
export const COINGECKO_COIN_PRICE_BY_CONTRACT_ADDRESS_DATASET: EvalDataset = [
	{
		inputs: {
			query:
				"What is the price of the token with contract address 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 on Ethereum?",
		},
		referenceOutputs: {
...
export const COINGECKO_POOL_DATA_BY_POOL_ADDRESS_DATASET: EvalDataset = [
	{
		inputs: {
			query:
				"Get data for the Uniswap V2 ETH/USDC pool with address 0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc",
		},
		referenceOutputs: {
			tool: "coingecko_get_pool_data_by_pool_address",
			response:
				'{"network":"ethereum","addresses":["0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc"]}',
		},
	},
];
...
export const COINGECKO_TOKEN_DATA_BY_TOKEN_ADDRESS_DATASET: EvalDataset = [
	{
		inputs: {
			query:
				"Get data for the USDC token with address 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 on Ethereum",
		},
		referenceOutputs: {
...
export const COINGECKO_TOKENS_INFO_BY_POOL_ADDRESS_DATASET: EvalDataset = [
	{
		inputs: {
			query:
				"Get information about all tokens in the Uniswap V2 ETH/USDC pool with address 0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc",
		},
		referenceOutputs: {
			tool: "coingecko_get_tokens_info_by_pool_address",
			response:
				'{"network":"ethereum","poolAddress":"0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc"}',
		},
	},
];
