...
export function filterPoolByRewardTokens(pools: any[], rewardTokens: any): any[] {
...
export function filterPoolByStableCoin(pools: any[], stableCoin: boolean): any[] {
...
export function filterPoolByUnderlyingTokens(pools: any[], underlyingTokens: any): any[] {
...
export function filterPoolByAllField(
    ...
    return pools.filter((pool) => {
        return (
            ...
            (rewardTokens === undefined || (pool.rewardTokens ?? []).includes(rewardTokens)) &&
