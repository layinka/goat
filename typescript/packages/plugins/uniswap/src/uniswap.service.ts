...
import type {
    ...
    UniswapLiquidityResponse,
    UniswapTransactionResponse,
...
export class UniswapService {
    ...
    @Tool({
        description: "Increase liquidity in an existing position. Returns the transaction to increase the position.",
    })
    ...
    @Tool({
        description: "Decrease liquidity in an existing position. Returns the transaction to decrease the position.",
    })
